package com.github.zhuyaotong.demo.guava.cache;
...
public class GuavaCacheUnitTest {
    ...
    public void whenCacheReachMaxSize_thenEviction() {
        ...
        final LoadingCache<String, String> cache =
                CacheBuilder.newBuilder().maximumSize(3).build(loader);
    ...
    public void whenCacheReachMaxWeight_thenEviction() {
        ...
        final LoadingCache<String, String> cache =
                CacheBuilder.newBuilder().maximumWeight(16)
                        .weigher(weighByLength).build(loader);
        cache.getUnchecked("first");
        cache.getUnchecked("second");
        cache.getUnchecked("third");
    ...
    public void whenEntryIdle_thenEviction() throws InterruptedException {
        ...
        final LoadingCache<String, String> cache =
                CacheBuilder.newBuilder().expireAfterAccess(2, TimeUnit.MILLISECONDS).build(loader);
