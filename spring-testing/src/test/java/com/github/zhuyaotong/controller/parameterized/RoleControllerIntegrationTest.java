package com.github.zhuyaotong.controller.parameterized;

import com.github.zhuyaotong.config.WebConfig;
...
public class RoleControllerIntegrationTest {
    ...
    public void givenEmployeeNameDoeWhenInvokeRoleThenReturnEmployee() throws Exception {
        this.mockMvc.perform(MockMvcRequestBuilders.get("/role/Doe"))
                .andDo(print()).andExpect(MockMvcResultMatchers.status().isOk())
                .andExpect(MockMvcResultMatchers.content().contentType(CONTENT_TYPE))
